...
namespace GLFW
{
    ...
    public class NativeWindow : SafeHandleZeroOrMinusOneIsInvalid, IEquatable<NativeWindow>
    {
        ...
        protected virtual void OnMaximizeChanged(bool maximized) => MaximizeChanged?.Invoke(this, new MaximizeEventArgs(maximized));
        ...
        protected virtual void OnContentScaleChanged(float xScale, float yScale) => ContentScaleChanged?.Invoke(this, new ContentScaleEventArgs(xScale, yScale));
        ...
        public void SetAspectRatio(int numerator, int denominator) => Glfw.SetWindowAspectRatio(Window, numerator, denominator);
        ...
        public void SetIcons([JetBrains.Annotations.NotNull] params Image[] images) => Glfw.SetWindowIcon(Window, images.Length, images);
        ...
        public void SetMonitor(Monitor monitor, int x, int y, int width, int height,
            int refreshRate = (int)Constants.Default) => Glfw.SetWindowMonitor(Window, monitor, x, y, width, height, refreshRate);
        ...
        public void SetSizeLimits(Size minSize, Size maxSize) => SetSizeLimits(minSize.Width, minSize.Height, maxSize.Width, maxSize.Height);
        ...
        public void SetSizeLimits(int minWidth, int minHeight, int maxWidth, int maxHeight) => Glfw.SetWindowSizeLimits(Window, minWidth, minHeight, maxWidth, maxHeight);
        ...
        protected virtual void OnCharacterInput(uint codePoint, ModifierKeys mods) => CharacterInput?.Invoke(this, new CharEventArgs(codePoint, mods));
        ...
        protected virtual void OnFileDrop([JetBrains.Annotations.NotNull] string[] paths) => FileDrop?.Invoke(this, new FileDropEventArgs(paths));
        ...
        protected virtual void OnFramebufferSizeChanged(int width, int height) => FramebufferSizeChanged?.Invoke(this, new SizeChangeEventArgs(new Size(width, height)));
        ...
        protected virtual void OnMouseButton(MouseButton button, InputState state, ModifierKeys modifiers) => MouseButton?.Invoke(this, new MouseButtonEventArgs(button, state, modifiers));
        ...
        protected virtual void OnMouseMove(double x, double y) => MouseMoved?.Invoke(this, new MouseMoveEventArgs(x, y));
        ...
        protected virtual void OnMouseScroll(double x, double y) => MouseScroll?.Invoke(this, new MouseMoveEventArgs(x, y));
        ...
        /// <param name="width">The new width.</param>
        /// <param name="height">The new height.</param>
        protected virtual void OnSizeChanged(int width, int height) => SizeChanged?.Invoke(this, new SizeChangeEventArgs(new Size(width, height)));
